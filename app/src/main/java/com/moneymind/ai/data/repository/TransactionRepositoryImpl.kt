...
class TransactionRepositoryImpl @Inject constructor(
    ...
    override suspend fun getInRange(ledger: Ledger?, start: Long, end: Long): List<TransactionEntity> =
        if (ledger == null) dao.getInRangeAll(start, end) else dao.getInRangeByLedger(ledger, start, end)
