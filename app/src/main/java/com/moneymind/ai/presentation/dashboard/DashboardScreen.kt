            ...
            item {
                Column(modifier = Modifier.padding(top = 12.dp)) {
                    NetWorthCard(
                        ...
                        breakdown = "Includes ${com.moneymind.ai.core.util.CurrencyFormatter.format(state.portfolioValue)} in investments, " +
                            "minus ${com.moneymind.ai.core.util.CurrencyFormatter.format(state.totalLiabilities)} owed"
                    )
                }
            }
