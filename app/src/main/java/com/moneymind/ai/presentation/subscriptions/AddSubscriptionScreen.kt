    ...
    Scaffold(
        ...
        Column(
            ...
            EnumDropdown(
                ...
                onSelected = viewModel::onBillingCycleChange,
                modifier = Modifier.fillMaxWidth()
            )
            ...
            OutlinedTextField(
                value = state.renewsInDaysText,
                onValueChange = viewModel::onRenewsInDaysChange,
                label = { Text("Next renewal in how many days? (optional)") },
